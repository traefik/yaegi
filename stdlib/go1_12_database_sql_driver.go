...
func init() {
	...
	Wrapper["database/sql/driver"] = map[string]reflect.Type{
		"ColumnConverter":                reflect.TypeOf((*_database_sql_driver_ColumnConverter)(nil)),
		"Conn":                           reflect.TypeOf((*_database_sql_driver_Conn)(nil)),
		"ConnBeginTx":                    reflect.TypeOf((*_database_sql_driver_ConnBeginTx)(nil)),
		"ConnPrepareContext":             reflect.TypeOf((*_database_sql_driver_ConnPrepareContext)(nil)),
		"Connector":                      reflect.TypeOf((*_database_sql_driver_Connector)(nil)),
		"Driver":                         reflect.TypeOf((*_database_sql_driver_Driver)(nil)),
		"DriverContext":                  reflect.TypeOf((*_database_sql_driver_DriverContext)(nil)),
		"Execer":                         reflect.TypeOf((*_database_sql_driver_Execer)(nil)),
		"ExecerContext":                  reflect.TypeOf((*_database_sql_driver_ExecerContext)(nil)),
		"NamedValueChecker":              reflect.TypeOf((*_database_sql_driver_NamedValueChecker)(nil)),
		"Pinger":                         reflect.TypeOf((*_database_sql_driver_Pinger)(nil)),
		"Queryer":                        reflect.TypeOf((*_database_sql_driver_Queryer)(nil)),
		"QueryerContext":                 reflect.TypeOf((*_database_sql_driver_QueryerContext)(nil)),
		"Result":                         reflect.TypeOf((*_database_sql_driver_Result)(nil)),
		"Rows":                           reflect.TypeOf((*_database_sql_driver_Rows)(nil)),
		"RowsColumnTypeDatabaseTypeName": reflect.TypeOf((*_database_sql_driver_RowsColumnTypeDatabaseTypeName)(nil)),
		"RowsColumnTypeLength":           reflect.TypeOf((*_database_sql_driver_RowsColumnTypeLength)(nil)),
		"RowsColumnTypeNullable":         reflect.TypeOf((*_database_sql_driver_RowsColumnTypeNullable)(nil)),
		"RowsColumnTypePrecisionScale":   reflect.TypeOf((*_database_sql_driver_RowsColumnTypePrecisionScale)(nil)),
		"RowsColumnTypeScanType":         reflect.TypeOf((*_database_sql_driver_RowsColumnTypeScanType)(nil)),
		"RowsNextResultSet":              reflect.TypeOf((*_database_sql_driver_RowsNextResultSet)(nil)),
		"SessionResetter":                reflect.TypeOf((*_database_sql_driver_SessionResetter)(nil)),
		"Stmt":                           reflect.TypeOf((*_database_sql_driver_Stmt)(nil)),
		"StmtExecContext":                reflect.TypeOf((*_database_sql_driver_StmtExecContext)(nil)),
		"StmtQueryContext":               reflect.TypeOf((*_database_sql_driver_StmtQueryContext)(nil)),
		"Tx":                             reflect.TypeOf((*_database_sql_driver_Tx)(nil)),
		"Value":                          reflect.TypeOf((*_database_sql_driver_Value)(nil)),
		"ValueConverter":                 reflect.TypeOf((*_database_sql_driver_ValueConverter)(nil)),
		"Valuer":                         reflect.TypeOf((*_database_sql_driver_Valuer)(nil)),
	}
}
